...
class ImageEncoder(tf.keras.Model):
    ...
    def call(self, inputs, training=False, mask=None):
        ...
        c1 = self.resnet_stage_1(img) # h/4 x w/4 x 64
        c2 = self.resnet_stage_2(c1)  # h/4 x w/4 x 256
        c3 = self.resnet_stage_3(c2)  # h/8 x w/8 x 512
        c4 = self.resnet_stage_4(c3)  # h/16 x w/16 x 1024
        c5 = self.resnet_stage_5(c4)  # h/32 x w/32 x 2048
        
        in2 = self.to_256ch_2(c2)  # h/4 x w/4 x 256
        in3 = self.to_256ch_3(c3)  # h/8 x w/8 x 256
        in4 = self.to_256ch_4(c4)  # h/16 x w/16 x 256
        in5 = self.to_256ch_5(c5)  # h/32 x w/32 x 256
